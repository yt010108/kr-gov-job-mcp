...
`normalize_job_role`, `search_public_jobs`, `fetch_job_detail`, `analyze_job_fit_report`, `analyze_institution_strategy`,
...
```json
{"registered_tools":10,"service":"kr-gov-job-mcp","status":"ok","version":"0.1.0"}
```
