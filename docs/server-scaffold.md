...
`search_public_jobs`, `fetch_job_detail`, `analyze_job_fit_report`,
...
```json
{"registered_tools":10,"revision":"unknown","service":"kr-gov-job-mcp","source_ref":"unknown","status":"ok","version":"0.1.0"}
```
