...
| 10 | `generate_star_answer_framework` | 분석 | P0 | [generate-star-answer-framework.md](generate-star-answer-framework.md) | 사용자 경험을 근거 기반 STAR 답변 뼈대로 정리한다. |

## 구현 순서

1. 01 `lookup_region_codes`
2. 02 `lookup_job_alio_codes`
3. 03 `search_public_jobs`
4. 04 `fetch_job_detail`
5. 09 `analyze_job_fit_report`
6. 06 `analyze_institution_strategy`
7. 07 `analyze_institution_weakness`
8. 08 `prepare_institution_interview`
9. 10 `generate_star_answer_framework`
