    ...
    if source_field_evidence:
        items.append(
            JobFitPreparationItem(
                ...
                rationale="공고 본문 필드는 서류와 면접 답변의 직접 기준입니다.",
                recommended_actions=[
...
def _institution_materials(
    ...
    materials = [
        InstitutionMaterialCheck(
            title="기관 최신 주요사업",
            reason="지원동기와 직무 연결 문장의 기준 자료입니다.",
            source_hint="ALIO 주요사업, 기관 홈페이지 사업 소개, 최근 보도자료",
        ),
        InstitutionMaterialCheck(
            title="기관 개선 과제",
            reason="면접에서 조심스럽게 기여 방향을 말할 때 필요합니다.",
