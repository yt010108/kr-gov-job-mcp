...
1. **처음 준비하는 사용자** — 관심 분야와 경력 수준부터 정하고 지원할 직무와 공고를 탐색합니다.
2. **지원할 공고를 찾는 사용자** — 목표 직무·경력·보유 역량을 바탕으로 지원할 공고를 비교합니다.
3. **지원 공고가 정해진 사용자** — 선택한 공고의 직무·평균보수·적합도·부족 역량을 분석하고 STAR 경험을 연결합니다.
4. **면접을 준비하는 사용자** — 기관 주요사업 → 기관 개선과제 → 공고 직무 → 예상 면접 질문 → STAR 경험 순서로 면접 준비 자료를 만듭니다.
